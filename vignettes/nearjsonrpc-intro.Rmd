...
```{r concentration_stake, eval = TRUE}
...
```{r hash_block, eval = TRUE}
near_get_block("CanDKa6nYDQ89iv5U7sE1YDFteBRkBG6qBJjiM5YwGtY")
```

## Check Transaction Status

```{r check_transaction, eval = TRUE}
near_get_transaction_status("B3ho6i6nDbJm95PpXuhbZXhGwZzJkhMkwf8qpbu35AMr", 
                            "meteor-relayer.near")
```
